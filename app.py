...
if st.session_state.get('show_guide_modal') and st.session_state.get('selected_guide'):
    ...
    # Simple card-style container for the guide
    st.markdown("### ")
    st.markdown("### ")
    ...
    '>
        <h2 style='color: #2c3e50; margin-top: 0;'>📝 {guide['title']}</h2>
        <p style='color: #666; border-bottom: 2px solid #e0e0e0; padding-bottom: 1rem;'>
    ...
    # Content in text area (scrollable)
    st.text_area(
        "Content:",
        value=guide['content'],
        height=400,
